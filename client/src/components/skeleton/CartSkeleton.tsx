    ...
    <Container className="py-8">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 lg:gap-8">
          ...
          <div className="xl:col-span-3">
            <div className="bg-babyshopWhite rounded-2xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="space-y-4">
                {[1, 2, 3].map((index) => (
                  <div
                    key={index}
                    className="border border-gray-200 rounded-lg p-4 lg:p-0 lg:border-0 lg:rounded-none"
                  >
                    ...
                    <div className="hidden lg:grid lg:grid-cols-12 gap-4 items-center py-6 border-b border-gray-200">
