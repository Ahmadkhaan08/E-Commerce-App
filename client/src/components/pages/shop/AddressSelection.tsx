...
const AddressSelection: React.FC<AddressSelectionProps> = ({
  ...
  return (
    <Card className="w-full">
      <CardHeader>Shipping Addresses</CardHeader>
      <CardContent>
        {addresses?.length === 0 ? (
          <div className="text-center py-12 px-6 ">
            <div className="w-20 h-15 mx-auto mb-6 bg-gray-100 rounded-full flex items-center justify-center">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              <DialogTrigger asChild>
                <Button className="bg-babyshopSky hover:bg-babyshopSky/90 text-white px-6 py-2">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input
                        ...
                        required
                        placeholder="House # 189, Street 4, F-11/2"
                        className="mt-1"
                      />
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex flex-col sm:flex-row gap-1 flex-shrink-0   ">
                        <Button
                          ...
                          className="p-2 h-8 w-8 hover:bg-babyshopSky/20 rounded-full hover:text-babyshopSky"
                          title="Edit Address"
                        >
                        ...
                        <Button
                          ...
                          disabled={isLoading}
                          className="p-2 h-8 w-8 hover:bg-red-50 rounded-full hover:text-red-600"
            ...
            <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen} >
              <DialogContent>
                ...
                <form onSubmit={handleEditAddress} className="space-y-4">
                  <div>
                    <Label htmlFor="edit-street" className="mb-2">Street Address</Label>
                    <Input
                      id="edit-street"
                      value={formData.street}
                      onChange={(e) =>
                  ...
                  <div>
                    <Label htmlFor="edit-city" className="mb-2">City</Label>
                    <Input
                      id="edit-city"
                      value={formData.city}
                      onChange={(e) =>
                  ...
                  <div>
                    <Label htmlFor="edit-country" className="mb-2">Country</Label>
                    <Input
                      id="edit-country"
                      value={formData.country}
                      onChange={(e) =>
                  ...
                  <div>
                    <Label htmlFor="edit-postalCode" className="mb-2">Postal Code</Label>
                    <Input
                      id="edit-postalCode"
                      value={formData.postalCode}
                      onChange={(e) =>
