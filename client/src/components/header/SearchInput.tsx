  ...
  return (
    <div ref={searchRef} className="relative lg:w-full">
      ...
      <button onClick={toggleMobileSearch} className="lg:hidden mt-1.5">
        {showSearch ? (
          <X className="w-5 h-5 text-babyshopBlack hover:text-babyshopRed hoverEffect" />
        ) : (
          <Search className="w-5 h-5 text-babyshopBlack hover:text-babyshopRed hoverEffect" />
        )}
      </button>
      <form
      ...
      <AnimatePresence>
        {showSearch && (
          <motion.div
            ...
            className="fixed lg:hidden left-0 top-20 w-full px-1 py-1 md:px-5 md:py-2 bg-white"
          >
