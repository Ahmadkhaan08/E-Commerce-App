    ...
    <div className="hidden md:inline-flex flex-col bg-babyshopWhite h-full p-5 border rounded-md">
        ...
        {featuredCategories.length > 0 ? (
          featuredCategories.map((item) => (
            <Link
              ...
              className="flex items-center gap-2 hover:text-babyshopSky hover:bg-babyshopSky/10  hoverEffect p-3 rounded-md"
            >
              <Image
                src={item?.image}
                alt={item.name}
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        ...
        <div className="bg-gradient-to-r from-babyshopSky/10 to-babyshopSky/5 p-3 rounded-md">
          ...
          <p className="text-xs text-gray-600 mb-2">On orders over 1500</p>
          <Link
            href="/shop"
