...
export default function MobileFooter({ onPressAbout, onPressContact, onPressTerms }: MobileFooterProps) {
  return (
    <View className="mb-4 mt-6 rounded-3xl border border-[#dfe8ff] bg-white p-4">
      ...
      <Text className="mt-1 text-sm text-[#6a789d]">Trusted essentials for moms and babies, delivered with care.</Text>
